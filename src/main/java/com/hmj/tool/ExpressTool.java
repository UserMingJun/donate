...
public class ExpressTool {
    ...
    public static void main(String args[]) throws Exception {
        ExpressTool expressTool = new ExpressTool();
        System.out.println(expressTool.orderOnlineByJson());
    }



    //电商ID
    private String EBusinessID="1636084";
    //电商加密私钥，快递鸟提供，注意保管，不要泄漏
    private String AppKey="b6707135-0222-43ee-9d41-3fdeaffbabbf";
    //测试请求url
...
//    private String ReqURL = "http://api.kdniao.com/api/OOrderService";
    ...
    public String orderOnlineByJson() throws Exception{
        String requestData= "{'OrderCode': '0126577003121'," +
                "'ShipperCode':'SF'," +
                "'PayType':1," +
                "'ExpType':1," +
                "'Cost':1.0," +
