...
<div class="grid">
    ...
    <form action="" method="post" class="form login" id="sendmailform">
        ...
        <div class="form__field">
            ...
            <input id="login__username" type="text" name="send_mail" class="form__input" placeholder="Email" required>
        </div>
