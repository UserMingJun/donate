        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li><a href="/menu/infoFinished" class="active"><i class="lnr lnr-file-empty"></i> <span>完成捐赠</span></a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">完成捐赠</h3>
                    </div>
                    <div class="panel-body">
                        <table class="table table-hover" id="finishedordertable">
                            <%--<thead>--%>
                            <%--<tr>--%>
                                <%--<th>寄件人姓名</th>--%>
                                <%--<th>寄件人电话</th>--%>
...
<script src="../js/info_finished.js"></script>
